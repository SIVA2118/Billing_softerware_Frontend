...
const S = {
    ...
    cardTopLine: { height: '1px', background: 'linear-gradient(90deg, transparent, rgba(201,168,76,0.25), transparent)' },
    ...
    buyerAvatar: {
        ...
        fontFamily: 'Cormorant Garamond, Georgia, serif',
        fontSize: '1rem', fontWeight: 600, color: '#c9a84c',
    },
    ...
    viewInvoicesLink: { fontSize: '0.7rem', color: 'rgba(201,168,76,0.4)', letterSpacing: '0.3px' },
    deleteBtn: {
    ...
    emptyIcon: { fontSize: '1.8rem', color: 'rgba(201,168,76,0.2)' },
